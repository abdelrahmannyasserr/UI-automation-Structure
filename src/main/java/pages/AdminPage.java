...
public class AdminPage extends PageBase {
    ...
    private final By employeeOption = By.xpath("//div[@role='listbox']//span[text()='Siva surya A']");
    ...
    public AdminPage selectEmployeeName(){
        selectByVisibleText(JsonUtility.jsonReader("employeeName", dataFile));
        return this;
    }
    ...
    public void assertThatTheNumberOfRecordIncreasedBy1() {
        ...
        System.out.println("The number of records at first iterate is " + num );
    }
    ...
    public void assertThatTheNumberOfRecordDecreasedByOne() {
        ...
        System.out.println("The number of records at second iterate is " + driver.findElement(numberOfRecordLabel).getText());
    }
}
